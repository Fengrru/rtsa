...
def load_gsm8k_traces(filepath: str, max_n: int = 50) -> list:
    ...
    from utils.gsm8k_loader import load_saved_traces
...
def main(
    ...
    from extractors.synthetic_validation import SyntheticValidator
    from extractors.agreement import compute_full_iaa, detect_length_bias
    ...
    if use_deepseek:
        ...
        if deepseek_api_key:
            from extractors.llm_extractor import create_extractor_e7
