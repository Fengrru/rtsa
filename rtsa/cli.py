...
def extract(cot_file: str, extractor: str, output: Optional[str], model: str):
    ...
    if extractor == "deepseek":
        from rtsa.extractors.llm_extractor import create_extractor_deepseek
...
def visualize(graph_file: str, output: Optional[str], title: Optional[str]):
    ...
    from rtsa.utils.visualize import plot_graph
...
def gcp():
    ...
    from rtsa.extractors.gcp_validator import GCPValidator, GCS_CORPUS_FULL
    from rtsa.extractors.rule_based import RuleBasedExtractor
    from rtsa.extractors.syntax_based import SyntaxBasedExtractor
    from rtsa.extractors.random_baseline import RandomBaselineExtractor
...
def compare(file1: str, file2: str):
    ...
    from rtsa.core.types import ReasoningTraceGraph
    from rtsa.core.metrics import compute_tsi, compute_level1_features, feature_distance
...
def fingerprint_enroll(model: str, graphs: str, output: str):
    ...
    from rtsa.core.types import ReasoningTraceGraph
    from rtsa.analysis.fingerprint import ModelFingerprint
