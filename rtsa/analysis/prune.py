...
from rtsa.core.metrics import GraphMetrics, compute_graph_features, compute_feature_matrix
...
class RedundancyAnalyzer:
    ...
    def _fuse_signal_scores(
        ...
        if self._cal_adapt is None and self.config.use_calibration_signal:
            from rtsa.analysis.signal_adapters import make_calibration_adapter
            self._cal_adapt = make_calibration_adapter()
        if self._prm_adapt is None and self.config.use_prm_signal:
            from rtsa.analysis.signal_adapters import make_prm_adapter
