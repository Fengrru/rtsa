...
from rtsa.core.metrics import compute_graph_features_batch
...
def _run_analyze(args, run_dir: Path) -> int:
    ...
    if args.labels_file:
        ...
        from rtsa.experiments.correlation_analysis import run as corr_run
        from rtsa.experiments.correlation_analysis import load_labels
...
def _run_prune(args, run_dir: Path) -> int:
    from rtsa.experiments.end_to_end_prune import run_experiment, print_report
...
def _run_calibrate(args, run_dir: Path) -> int:
    from rtsa.experiments.calibrate_thresholds import run as cal_run
...
def _run_annotate(args, run_dir: Path) -> int:
    from rtsa.experiments.annotate_steps import annotate_trace
